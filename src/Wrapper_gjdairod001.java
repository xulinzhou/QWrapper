    	...
    	String monetaryunit = "MYR";
			...
			try {
			 ...
			 if(StringUtils.isNotEmpty(arg1.getRetDate())){
		         ...
		         String  dep  =    StringUtils.substringBetween(htmlCompress, "ctl00_BodyContentPlaceHolder_tblOutFlightBlocks", "ctl00_BodyContentPlaceHolder_pnlRetFlights");
		         String  arrHtml  =    StringUtils.substringBetween(htmlCompress, "ctl00_BodyContentPlaceHolder_tblInFlightBlocks", "panellegend");
	             String count[] = StringUtils.substringsBetween(arrHtml, "ctl00_BodyContentPlaceHolder_flightRowInbound", "\"");
	             ...
	             for(int k=0;k<count.length;k++){
	            	 ...
	            	 if(countFlightInfo == 1){
	            		 segs = new ArrayList<FlightSegement>();
		                    ...
		                    flightDetail.setPrice(Double.parseDouble(price)+Double.parseDouble(tax));
